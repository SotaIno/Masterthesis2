...
\section{量子ビットゲート}
    ...
    \begin{figure}[H]
        \begin{center}
            \includegraphics[width=12cm]{QCmodel.png}
            \caption{量子回路モデル}
        \end{center}
    \end{figure}
    ...
    \subsection{CZゲート}
        ...
        \subsubsection{実装上の課題1.CZゲートのNon-Adiabaticエラー}
        ...
        \begin{figure}[H]
            \begin{center}
                \includegraphics[width=12cm]{pulsewithnoise.png}
    ...
    \subsection{Fast-Adaibatic pulse}
